...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package paredit
    ...
    :ensure t
    :hook
    ((racket-mode lisp-mode ulisp-mode scheme-mode emacs-lisp-mode clojure-mode clojurec-mode) . paredit-mode))
  ...
  (use-package lispy
    ...
    :diminish (lispy-mode)
    :hook
    ((racket-mode lisp-mode ulisp-mode scheme-mode emacs-lisp-mode clojure-mode) . lispy-mode))

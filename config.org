...
(setq erc-track-shorten-start 8
      ...
      erc-auto-query 'bury
      erc-modules '(autoaway autojoin button completion fill irccontrols list log match menu move-to-prompt netsplit networks noncommands notify notifications readonly ring sound stamp track)
      ...
      erc-autojoin-mode t
      erc-autojoin-channels-alist '(("irc.libera.chat" "#clschool" "#commonlisp" "#ecl" "#lisp" "#scheme" "#guile" "#guix") ("irc.rizon.net" "#c0de" "#rice" "#bible")))
      
(erc-select :server "127.0.0.1" :port "6667" :nick "goober" :password "bellie9092")
(erc-select :server "irc.libera.chat" :port "6667" :nick "gooba" :password "bajsa")
(erc-select :server "irc.rizon.net" :port "6667" :nick "goober" :password "bajsa")
erc-auto-query 'bury
erc-modules
   '(autoaway autojoin button completion fill irccontrols list log match menu move-to-prompt netsplit networks noncommands notify notifications readonly ring sound stamp track)
#+END_SRC
* Eshell
** Why Eshell?
